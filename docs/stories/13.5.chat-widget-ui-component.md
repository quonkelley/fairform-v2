...
- [ ] Task 1: Create chat widget component (AC: 1, 4)
  - [ ] Create `components/ai-copilot/ChatWidget.tsx`
  - [ ] Implement floating bubble with proper positioning
  - [ ] Add smooth expand/collapse animations using Framer Motion
  - [ ] Use Tailwind CSS for styling consistent with design system
  - [ ] Make widget always visible (z-index: 1000)

- [ ] Task 2: Implement unread message indicator (AC: 2)
  - [ ] Add unread count badge to widget
  - [ ] Connect to unread message state from React Query
  - [ ] Animate badge appearance/disappearance
  - [ ] Limit count display (e.g., "99+" for large numbers)
  - [ ] Clear unread count when chat is opened

- [ ] Task 3: Add click handler and panel integration (AC: 3)
  - [ ] Implement onClick handler to toggle chat panel
  - [ ] Pass state to parent component or context
  - [ ] Handle widget click to open panel
  - [ ] Prevent click propagation when appropriate

- [ ] Task 4: Implement smooth animations (AC: 4)
  - [ ] Use Framer Motion for expand/collapse animations
  - [ ] Add hover effects for better UX
  - [ ] Implement scale and rotation animations
  - [ ] Add transition delays for smooth state changes
  - [ ] Optimize animations for performance

- [ ] Task 5: Add keyboard accessibility (AC: 5)
...
- [ ] Task 6: Implement responsive design (AC: 6)
  - [ ] Adjust widget size for mobile screens
  - [ ] Reposition widget on small screens if needed
  - [ ] Test on various screen sizes (320px to 1920px+)
  - [ ] Use responsive Tailwind classes
  - [ ] Handle landscape/portrait orientation

- [ ] Task 7: Add connection status indicator (AC: 7)
  - [ ] Show connection status with colored dot/icon
  - [ ] Green: Connected, Yellow: Connecting, Red: Disconnected
  - [ ] Add tooltip with status text
  - [ ] Animate status changes
  - [ ] Handle reconnection attempts

- [ ] Task 8: Integrate with design system (AC: 8)

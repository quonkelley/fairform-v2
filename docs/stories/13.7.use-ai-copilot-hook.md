...
- [ ] Task 1: Create hook structure and types (AC: 1)
  - [ ] Create `lib/hooks/useAICopilot.ts`
  - [ ] Define hook interface and return types
  - [ ] Import required dependencies (React Query, repositories)
  - [ ] Set up hook parameters and configuration

- [ ] Task 2: Implement session management (AC: 1, 6)
  - [ ] Create useSession hook for session state
  - [ ] Implement session creation and loading
  - [ ] Handle session switching and context updates
  - [ ] Integrate with aiSessionsRepo for persistence
  - [ ] Add session validation and error handling

- [ ] Task 3: Implement message state management (AC: 2, 4)
  - [ ] Create useMessages hook for message history
  - [ ] Implement unread count tracking
  - [ ] Handle message pagination and loading
  - [ ] Add real-time message updates
  - [ ] Integrate with React Query infinite queries

- [ ] Task 4: Implement connection status management (AC: 2, 8)
  - [ ] Create connection status state
  - [ ] Implement connection monitoring
  - [ ] Handle reconnection logic
  - [ ] Add connection status indicators
  - [ ] Implement retry logic with exponential backoff

- [ ] Task 5: Implement message sending functionality (AC: 3, 4)
  - [ ] Create sendMessage function with SSE streaming
...
- [ ] Task 6: Integrate with React Query (AC: 5)
  - [ ] Set up query keys for sessions and messages
  - [ ] Implement cache invalidation strategies
  - [ ] Add optimistic updates for messages
  - [ ] Handle background refetching
  - [ ] Implement proper cache synchronization

- [ ] Task 7: Add context awareness (AC: 6)
  - [ ] Integrate with current case context
  - [ ] Handle user preferences and settings
  - [ ] Implement context snapshot updates
  - [ ] Add automatic context injection
  - [ ] Handle context changes and updates

- [ ] Task 8: Implement demo mode support (AC: 7)
  - [ ] Add demo mode detection
  - [ ] Handle demo-specific configuration
  - [ ] Implement demo data fallbacks
  - [ ] Add demo session management
  - [ ] Handle demo/production switching
